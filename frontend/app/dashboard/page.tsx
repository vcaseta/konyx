...
export default function DashboardPage() {
  ...
  // Config
  const [passNueva, setPassNueva] = useState<string>("");
  const [apiHoldedKissoro, setApiHoldedKissoro] = useState<string>("");
  const [apiHoldedEnPlural, setApiHoldedEnPlural] = useState<string>("");
    ...
    >
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-[280px_1fr] gap-6">
        ...
        <aside className="md:sticky md:top-6">
          <div className="bg-slate-200/90 backdrop-blur rounded-2xl shadow p-4">
            <div className="flex justify-center mb-4">
              <img
                src="/logo.png"
                alt="Konyx"
                className="h-24 w-auto drop-shadow-md" /* 96px de alto */
              />
            </div>
          ...
          <div className="bg-white/90 backdrop-blur rounded-2xl shadow p-6">
            ...
            {menu === "config" && (
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-2">Cambio de contraseña</h3>
                  <input
                    type="password"
                    value={passNueva}
                ...
                <div>
                  <h3 className="text-sm font-semibold mb-2">Formatos Excel</h3>
                  <p className="text-sm text-gray-600">
                    (Configuración de columnas, validaciones, etc. — pendiente de definir)
                  </p>
                </div>
              </div>
            )}

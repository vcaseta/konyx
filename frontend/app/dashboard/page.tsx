    ...
    <main className="min-h-screen bg-no-repeat bg-center bg-cover p-4" style={{backgroundImage:"url(/fondo.png)", backgroundSize:"100% 100%", backgroundRepeat:"no-repeat"}}>
      <div className="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-[260px_1fr] gap-6">
        ...
        <section className="space-y-6">
          ...
          {menu==="fecha" && <div className="bg-white/90 backdrop-blur rounded-2xl shadow p-6">
          ...
          {menu==="cuenta" && <div className="bg-white/90 backdrop-blur rounded-2xl shadow p-6">
            <h2 className="text-lg font-semibold mb-4">Cuenta contable</h2>
            <OptionGrid options={CUENTAS} value={cuenta} onChange={setCuenta} />
            {cuenta==="Otra (introducir)" && <input type="text" value={cuentaOtra} onChange={e=>setCuentaOtra(e.target.value)} placeholder="Introduce tu cuenta" className="mt-4 w-full rounded-lg border border-indigo-300 px-3 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-500"/>}
          </div>}
          {menu==="fichero" && <div className="bg-white/90 backdrop-blur rounded-2xl shadow p-6">
